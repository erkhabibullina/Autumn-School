...
class MainActivity : AppCompatActivity() {
    ...
    private fun setListeners() {
        val clickableViews: List<View> = listOf(box_one_text, box_two_text, box_three_text, box_four_text, box_five_text, green_button, yellow_button, red_button, constraint_layout)
