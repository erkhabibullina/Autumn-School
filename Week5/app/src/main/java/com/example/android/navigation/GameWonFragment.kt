...
class GameWonFragment : Fragment() {
    ...
    private fun getShareIntent() : Intent {
        ...
        return ShareCompat.IntentBuilder.from(requireActivity()).setText(resources.getString(R.string.share_success_text, args.numCorrect, args.numQuestions)).setType("text/plain").intent
    }
